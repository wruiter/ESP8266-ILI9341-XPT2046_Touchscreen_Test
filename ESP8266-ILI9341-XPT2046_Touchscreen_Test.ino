...
#define TFT_DC 2   /** Arduino pin (2=D4)*/
#define TFT_CS 15  /** Arduino pin (15=D8)*/
#define TCH_IRQ 16 /** Arduino pin (16=D0)*/
#define TCH_CS 0   /** Arduino pin ( 0=D3)*/

Adafruit_ILI9341 tft = Adafruit_ILI9341(TFT_CS, TFT_DC);
XPT2046 touch(TCH_CS, TCH_IRQ);

/*XPT2046 touch(4,  5); /** Arduino pins (4=D2, 5=D1)*/
/*XPT2046 touch(/*cs= 0, /*irq= 16); /** Arduino pins (0=D3, 16=D0)*/
...
void setup() {
 ...
 // touch.setCalibration(1832, 262, 264, 1782);
  touch.setCalibration(1840, 1751, 282, 232);
